#!/bin/bash
# PlayAgain2（再刷一把2 v0.6.3）MOD 直装包一键构建
# 原版 APK 进 -> 成品 build/PlayAgain2-mod.apk 出，全自动。
# 用法: bash PlayAgain2/build.sh [原版APK] [设备序列号]
#   原版APK     默认 PlayAgain2/game.apk（脚本校验 md5，必须与补丁基线一致）
...
FINAL="$OUT/PlayAgain2-mod.apk"
KNOWN_MD5="27f0bcd684b1b286f57e303208514838"   # game.apk (v0.6.3, versionCode 63)
